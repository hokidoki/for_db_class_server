...
router.get('/search',function(req,res,next){
    ...
    let query = `SELECT PROFILE_IMAGE,ID,NAME, DUMMY.CHECK, DUMMY.FRIENDS_ROW_ID AS ROW_ID FROM USER left outer join 
    ...
    connection.query(query,function(err,users){
        ...
        connection.query(queryForgroup,function(err,addedGroupInfo){
            let queryForArticle = `select USER.ID as ID ,PROFILE_IMAGE,USER.NAME, article.ARTICLE_ID as ARTICLE_ROW_ID,MORNING,LUNCH,DINNER,CREATED_DATE,article.COMMENT as CONTENTS,IMAGE_ROW_ID,IMAGE_URL 
